    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex items-center justify-center bg-black">
        <div className="bg-[#121212] p-8 rounded-xl w-100 border-2 border-[#252527] h-auto shadow-lg text-center">
          ...
          <button onClick={handleSignup} type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-md text-sm px-9 py-4 mt-8 text-center me-2 mb-8">Create an account</button>
